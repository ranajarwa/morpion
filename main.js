...
function clickHome(){
  ...
  window.location.href = "/morpion/Jeu.html";
}

function clickRes(){
  window.location.href = "/morpion/Accueil.html";
}

function jouer(cas,n){
  console.log(cas.src);
  if(tour && cas.src=="http://192.168.1.106/morpion/Images/blanc.png"){
    cas.src=croix;
    tour=false;
  ...
  else if(cas.src=="http://192.168.1.106/morpion/Images/blanc.png"){
    cas.src=rond;
    tour=true;
...
function resultat(){
  ...
  if (cas1=="xxx"||cas2=="xxx"||cas3=="xxx"||cas4=="xxx"||cas5=="xxx"||cas6=="xxx"||cas7=="xxx"||cas8=="xxx"){
    ...
    window.location.href = "/morpion/Resultat.html";
  }
